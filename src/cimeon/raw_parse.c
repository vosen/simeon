...
static const YYACTIONTYPE yy_action[] = {
 /*     0 */    24,    1,   10,    6,    8,    3,    2,   12,    5,   16,
 /*    10 */     9,   14,   13,   11,    7,    4,    9,   25,   25,   25,
 /*    20 */    15,
};
static const YYCODETYPE yy_lookahead[] = {
 /*     0 */    12,   13,   14,    6,    2,    8,    3,    9,   10,    0,
 /*    10 */     1,    4,    7,    9,   15,    5,    1,   16,   16,   16,
 /*    20 */    14,
};
...
static const char *const yyTokenName[] = { 
  "$",             "POUND",         "NOT",           "LBRACKET",    
  "RBRACKET",      "IDENT",         "EQ",            "STRING_LIT",  
  "LPAREN",        "RPAREN",        "COMMA",         "error",       
  "crate",         "attrs",         "inner_attr",    "meta_item",   
};
#endif /* NDEBUG */
...
static const char *const yyRuleName[] = {
 /*   0 */ "crate ::= attrs",
 /*   1 */ "attrs ::= inner_attr",
 /*   2 */ "attrs ::= attrs inner_attr",
 /*   3 */ "inner_attr ::= POUND NOT LBRACKET meta_item RBRACKET",
 /*   4 */ "meta_item ::= IDENT EQ STRING_LIT",
 /*   5 */ "meta_item ::= IDENT LPAREN RPAREN",
 /*   6 */ "meta_item ::= IDENT LPAREN COMMA RPAREN",
};
#endif /* NDEBUG */
